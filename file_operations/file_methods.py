...
class File_Operation:
    ...
    def save_model(self,model,filename):
        """
            ...
            Revisions: None
"""
        self.logger_object.log(self.database,self.name, 'Entered the save_model method of the File_Operation class')
        try:
            ...
            self.logger_object.log(self.database,self.name,'Exception occured in save_model method of the Model_Finder class. Exception message:  ' + str(e))
            self.logger_object.log(self.database,self.name,
    ...
    def load_model(self,filename):
        """
                    ...
                    Revisions: None
        """
        self.logger_object.log(self.database,self.name, 'Entered the load_model method of the File_Operation class')
        try:
    ...
    def find_correct_model_file(self,cluster_number):
        """
                            ...
                            Revisions: None
                """
        self.logger_object.log(self.database,self.name, 'Entered the find_correct_model_file method of the File_Operation class')
        try:
