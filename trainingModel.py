...
class trainModel:
    ...
    def __init__(self):
        ...
        self.database = "WAFERFAULT-TRAINING-LOGS"
        self.name = "ModelTrainingLog"
        #self.file_object = open("Training_Logs/ModelTrainingLog.txt", 'a+')

    def trainingModel(self,csvdata):
        # Logging the start of Training

        self.log_writer.log(self.database,self.name, 'Start of Training')
        try:
            ...
            kmeans=clustering.KMeansClustering(self.database,self.name,self.log_writer) # object initialization.
            ...
            for i in list_of_clusters:
                ...
                model_finder=tuner.Model_Finder(self.database,self.name,self.log_writer) # object initialization

                #getting the best model for each of the clusters
                best_model_name,best_model=model_finder.get_best_model(x_train,y_train,x_test,y_test)

                #saving the best model to the directory.
                file_op = file_methods.File_Operation(self.database,self.name,self.log_writer)
